...
<body>
    ...
    <form id="form1" style="width: 100%;" runat="server">
        <main>
            <div class="error_block" id="not_verify_email_error" runat="server">
                <p>Your email address is not verified. <strong>Check your inbox</strong> and verify your account.</p>
            </div>
